...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
		      <td colspan='5'><h3>tekton-chains</h3></td>
		    </tr>
	    <tr>
	      <td>tekton-chains</td>
	      <td title='A Helm chart for Tekton Chains'><a href='https://github.com/tektoncd/chains'> <img src='https://github.com/tektoncd/chains/blob/main/tekton_chains-color.png' width='24px' height='24px'> tekton-chains</a></td>
	      <td>0.2.3</td>
	      <td></td>
	      <td></td>
	    </tr>
